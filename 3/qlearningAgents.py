...
class QLearningAgent(ReinforcementAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        sample = float(reward + self.discount*self.computeValueFromQValues(nextState))
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        states = features.keys()
        for state in states:
          self.weights[state] = self.weights[state] + self.alpha * diff * features[state]
        return
        util.raiseNotDefined()
